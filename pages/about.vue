...
2024 年，我進一步修習了國立台北商業大學商溫明輝教授開設的《UX 三刀流》課程，開始更有意識地去看見「使用者體驗」與「前端設計」之間的連結，也為我後續的開發工作打下了更完整的思維基礎。<br><br>
我是一個喜歡獨立思考，也享受與人協作的人。平時總是帶著一份好奇心在學習，也會默默把每一段經歷放進自己的工具箱，等著在對的時候拿出來用。我習慣主動出擊、主動整理，也習慣在專案中用小小的迭代持續推進目標。<br><br>
生活中，我喜歡登山、打球、健身，也喜歡煮飯、看書、拍照與逛美術館。這些興趣讓我能在專注之中找到節奏，在規律裡保有彈性，也讓我對「使用者感受」多了一層直覺式的理解。<br><br>
我相信，好的前端開發不是完成任務而已，而是透過細節的照顧，讓使用者的每一次互動都變得自然、流暢、甚至溫暖。<br><br>
未來，我希望能加入一個重視創意與體驗的團隊，和彼此信任的夥伴一起，打造實用又動人的產品。<br><br>
2025年，我參與了以下幾個重要項目：<br>
