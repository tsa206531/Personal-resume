  ...
  const projects = ref([
      {
        ...
        {
          title: 'ideabox',
          desc: '用gpt產生骨架+builderio+promept所產生',
          image: 'https://raw.githubusercontent.com/tsa206531/OverTask25/refs/heads/main/img/ideabox22.jpg',
          link: 'https://ideabox-git-aimain8df0b27c0b64-yl-chens-projects.vercel.app/'
        },
        {
          title: '景點收尋器',
        ...
        {
          title: 'Bst5 格線練習',
          desc: '使用bootstrap5 格線系統 建立表單。 (2023)',
